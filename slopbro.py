...
TARGET_APPS = [
    ("com.webos.app.voiceweb", "URL", [6, 11]),
    (
...
def run(
    ...
    try:
        ...
        # Debug: check foreground app after launch
        import time
        time.sleep(1)
        ...
        try:
            ...
            log("FOREGROUND AFTER LAUNCH: %r" % info)
        except Exception as exc:
            log("foreground query failed: %s" % exc)
